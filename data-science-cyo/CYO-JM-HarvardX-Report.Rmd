...
author: "Justo Andr̩s Manrique Urbina"
...
We will evaluate this algorithms using RMSE loss function. The lower the RMSE is, the better the algorithm is. Each algorith will be cross-validated and fine tuned using caret package in R.
